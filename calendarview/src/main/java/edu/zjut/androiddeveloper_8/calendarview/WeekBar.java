package edu.zjut.androiddeveloper_8.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("edu.zjut.androiddeveloper_8.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("edu.zjut.androiddeveloper_8.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {

...
public class SMSMethod {
    ...
    public void SendMessage(String strDestAddress, String strMessage){
        ...
        try {
            ...
            PendingIntent mSendPI = PendingIntent.getBroadcast(mContext, 0, itSend, FLAG_IMMUTABLE);

            /* deliveryIntent参数为送达后接受的广播信息PendingIntent */
            PendingIntent mDeliverPI = PendingIntent.getBroadcast(mContext, 0, itDeliver, FLAG_IMMUTABLE);
